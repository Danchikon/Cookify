...
namespace Cookify.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230204195441_BiggerTitleAndNameConstraint")]
    partial class BiggerTitleAndNameConstraint
    {
            ...
            modelBuilder.Entity("Cookify.Domain.Favorite.FavoriteEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 19, 54, 41, 744, DateTimeKind.Unspecified).AddTicks(765), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Ingredient.IngredientEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 19, 54, 41, 744, DateTimeKind.Unspecified).AddTicks(4033), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Like.LikeEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 19, 54, 41, 744, DateTimeKind.Unspecified).AddTicks(8199), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.MealCategory.RecipeCategoryEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 19, 54, 41, 745, DateTimeKind.Unspecified).AddTicks(2616), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.ProductMarket.ProductMarketEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 19, 54, 41, 745, DateTimeKind.Unspecified).AddTicks(1675), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Recipe.RecipeEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 19, 54, 41, 745, DateTimeKind.Unspecified).AddTicks(4472), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.User.UserEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 19, 54, 41, 745, DateTimeKind.Unspecified).AddTicks(8281), new TimeSpan(0, 0, 0, 0, 0)));
