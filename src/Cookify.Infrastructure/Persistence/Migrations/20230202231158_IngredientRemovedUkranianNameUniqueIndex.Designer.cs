...
namespace Cookify.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230202231158_IngredientRemovedUkranianNameUniqueIndex")]
    partial class IngredientRemovedUkranianNameUniqueIndex
    {
            ...
            modelBuilder.Entity("Cookify.Domain.Favorite.FavoriteEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 2, 23, 11, 57, 941, DateTimeKind.Unspecified).AddTicks(4355), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Ingredient.IngredientEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 2, 23, 11, 57, 941, DateTimeKind.Unspecified).AddTicks(8176), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Like.LikeEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 2, 23, 11, 57, 942, DateTimeKind.Unspecified).AddTicks(3178), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.MealCategory.MealCategoryEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 2, 23, 11, 57, 942, DateTimeKind.Unspecified).AddTicks(6692), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Recipe.RecipeEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 2, 23, 11, 57, 942, DateTimeKind.Unspecified).AddTicks(8537), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.User.UserEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 2, 23, 11, 57, 943, DateTimeKind.Unspecified).AddTicks(2556), new TimeSpan(0, 0, 0, 0, 0)));
