...
namespace Cookify.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230204171736_RenamedMealCategoryToRecipeCategory")]
    partial class RenamedMealCategoryToRecipeCategory
    {
            ...
            modelBuilder.Entity("Cookify.Domain.Favorite.FavoriteEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 17, 17, 35, 908, DateTimeKind.Unspecified).AddTicks(1470), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Ingredient.IngredientEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 17, 17, 35, 908, DateTimeKind.Unspecified).AddTicks(4810), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Like.LikeEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 17, 17, 35, 908, DateTimeKind.Unspecified).AddTicks(9051), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.MealCategory.RecipeCategoryEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 17, 17, 35, 909, DateTimeKind.Unspecified).AddTicks(3432), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.ProductMarket.ProductMarketEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 17, 17, 35, 909, DateTimeKind.Unspecified).AddTicks(2442), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.Recipe.RecipeEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 17, 17, 35, 909, DateTimeKind.Unspecified).AddTicks(6324), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("Cookify.Domain.User.UserEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2023, 2, 4, 17, 17, 35, 910, DateTimeKind.Unspecified).AddTicks(4), new TimeSpan(0, 0, 0, 0, 0)));
